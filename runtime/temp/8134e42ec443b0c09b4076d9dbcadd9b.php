<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/var/www/html/supervision/public/../application/common/view/tpl/dispatch_jump.tpl";i:1545127447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="system-message <?php echo $codeText; ?>">
    <div class="image">
        <img src="/supervision/public/assets/img/<?php echo $codeText; ?>.svg" alt="" width="150" />
    </div>
    <h1><?php echo $msg; ?></h1>
    <?php if($url): ?>
        <p class="jump">
    ...
    <?php endif; ?>
    <p class="clearfix">
        <a href="/supervision/public/" class="btn btn-grey"><?php echo __('Go back'); ?></a>
        <?php if($url): ?>
...
<div class="copyright">
    <p>Powered by 高要区建设工程质量安全监督管理系统</p>
</div>
<?php if($url): ?>
